                            ...
                            <div className="row">
                                <div className="col-lg-3 col-md-3 col-sm-6 col-12 mb-2 align-self-center">
                                    <div className="footer-top__logo">
                                        <Link to="/">
                                            <img src="/frontend/assets/images/logo_use3.png" className="img-fluid" alt="Image_logo" />
                                        </Link>
                                    </div>
                        ...
                        <div className="footer-bottom">
                            <div className="footer-bottom__copyright text-center">
                                <Link to="/" className="footer-bottom__copyright-link">
                                    CopyRight <span id="year">{this.getCurrentYear()}</span> Developer by ChuongDev . All Rights Reserved.
                                </Link>
                            </div>
                        </div>
                    </div>
